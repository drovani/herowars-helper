...
describe('Player Teams Edit Integration', () => {
  ...
  describe('loader', () => {
    it('should load team and user hero collection successfully', async () => {
      ...
      mockTeamRepo.findTeamWithHeroes.mockResolvedValue({ data: mockTeam, error: null })
      ...
      expect(mockTeamRepo.findTeamWithHeroes).toHaveBeenCalledWith(mockTeamId, 'user1')
    ...
    it('should throw error when team is not found', async () => {
      mockTeamRepo.findTeamWithHeroes.mockResolvedValue({ data: null, error: null })
  ...
  describe('action - updateTeam', () => {
    it('should update team successfully', async () => {
      ...
      expect(result.message).toBe('Team "Updated Arena Team" updated successfully')
      expect(mockTeamRepo.updateTeam).toHaveBeenCalledWith(mockTeamId, 'user1', {
        name: 'Updated Arena Team',
        description: 'Updated description'
      })
    })
  ...
  describe('action - addHero', () => {
    it('should add hero to team successfully', async () => {
      ...
      expect(mockTeamRepo.addHeroToTeam).toHaveBeenCalledWith(mockTeamId, 'user1', { hero_slug: 'aurora' })
    })
  ...
  describe('action - removeHero', () => {
    it('should remove hero from team successfully', async () => {
      ...
      expect(mockTeamRepo.removeHeroFromTeam).toHaveBeenCalledWith(mockTeamId, 'user1', 'astaroth')
    })
