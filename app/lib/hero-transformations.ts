 ...
 */
export function transformCompleteHeroToRecord(completeHero: CompleteHero): HeroRecord {
 ...
 */
export function transformArtifacts(artifacts: CompleteHero['artifacts'] | undefined): HeroRecord['artifacts'] | undefined {
  ...
  for (const artifact of artifacts) {
    if (artifact.artifact_type === 'weapon' && artifact.name && artifact.team_buff) {
      result.weapon = {
        ...
        team_buff_secondary: artifact.team_buff_secondary ? validateTeamBuff(artifact.team_buff_secondary) : undefined,
      };
 ...
 */
export function transformSkins(skins: CompleteHero['skins'] | undefined): HeroRecord['skins'] {
 ...
 */
export function transformGlyphs(glyphs: CompleteHero['glyphs'] | undefined): HeroRecord['glyphs'] {
 ...
 */
export function transformEquipmentSlots(equipmentSlots: CompleteHero['equipmentSlots'] | undefined): HeroRecord['items'] {
...
export function validateAttackTypes(attackTypes: string[]): HeroRecord['attack_type'] {
...
export function validateTeamBuff(teamBuff: string): NonNullable<HeroRecord['artifacts']>['weapon']['team_buff'] {
  const validBuffs = [
...
export function validateBookName(bookName: string): NonNullable<HeroRecord['artifacts']>['book'] {
  const validBooks = [
...
export function validateSkinStat(statType: string): NonNullable<HeroRecord['skins']>[0]['stat'] {
  const validStats = [
