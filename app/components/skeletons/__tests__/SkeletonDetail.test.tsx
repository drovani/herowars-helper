...
describe('SkeletonDetail', () => {
  ...
  describe('breadcrumbs', () => {
    it('should show breadcrumbs by default', () => {
      ...
      const breadcrumbContainer = result.container.querySelector('div[class*="flex"][class*="items-center"][class*="space-x-2"]')
    ...
    it('should render breadcrumb skeleton elements', () => {
      ...
      const breadcrumbSkeletons = result.container.querySelectorAll('[class*="h-4"][class*="w-12"], [class*="h-4"][class*="w-16"], [class*="h-4"][class*="w-20"]')
  ...
  describe('layout modes', () => {
    it('should render single column layout by default', () => {
      ...
      const layoutContainer = result.container.querySelector('[class*="space-y-6"]:not([class*="grid"])')
    ...
    it('should render two-column layout when specified', () => {
      ...
      const gridContainer = result.container.querySelector('[class*="grid"][class*="grid-cols-1"][class*="lg:grid-cols-2"]')
  ...
  describe('header section', () => {
    it('should render header card with image by default', () => {
      ...
      const imageSkeleton = result.container.querySelector('[class*="size-32"][class*="rounded-lg"]')
    ...
    it('should render header information skeletons', () => {
      ...
      const titleSkeleton = result.container.querySelector('[class*="h-8"][class*="w-48"]')
      expect(titleSkeleton).toBeInTheDocument()
      
      // Should have badge/tag skeletons
      const badgeSkeletons = result.container.querySelectorAll('[class*="h-6"][class*="w-16"], [class*="h-6"][class*="w-20"]')
      expect(badgeSkeletons.length).toBeGreaterThanOrEqual(3)
      
      // Should have description skeleton
      const descriptionSkeleton = result.container.querySelector('[class*="h-4"][class*="w-64"]')
  ...
  describe('content sections', () => {
    ...
    it('should render section headers with skeleton titles', () => {
      ...
      const sectionTitles = result.container.querySelectorAll('[class*="h-6"][class*="w-32"]')
    ...
    it('should render custom section titles', () => {
      ...
      const result = render(<SkeletonDetail sectionTitles={sectionTitles} contentSections={3} />)
    ...
    it('should mix custom titles with skeleton placeholders', () => {
      ...
      const result = render(<SkeletonDetail sectionTitles={sectionTitles} contentSections={4} />)
      
      expect(result.getByText('Stats')).toBeInTheDocument()
      expect(result.getByText('Equipment')).toBeInTheDocument()
      
      // Should have skeleton placeholders for remaining sections
      const skeletonTitles = result.container.querySelectorAll('[class*="h-6"][class*="w-32"]')
  ...
  describe('section content structure', () => {
    it('should render proper content structure in each section', () => {
      ...
      const gridLayout = result.container.querySelector('[class*="grid"][class*="grid-cols-2"][class*="gap-4"]')
      expect(gridLayout).toBeInTheDocument()
      
      // Should have label-value pairs
      const labelSkeletons = result.container.querySelectorAll('[class*="h-4"][class*="w-20"], [class*="h-4"][class*="w-16"]')
      expect(labelSkeletons.length).toBeGreaterThanOrEqual(2)
      
      const valueSkeletons = result.container.querySelectorAll('[class*="h-6"][class*="w-24"], [class*="h-6"][class*="w-28"]')
    ...
    it('should render full-width content lines', () => {
      ...
      const fullWidthLine = result.container.querySelector('[class*="h-4"][class*="w-full"]')
      const partialWidthLine = result.container.querySelector('[class*="h-4"][class*="w-3/4"]')
  ...
  describe('skeleton elements', () => {
    ...
    it('should use proper size classes for different elements', () => {
      ...
      const imageSkeleton = result.container.querySelector('[class*="size-32"]')
      expect(imageSkeleton).toBeInTheDocument()
  ...
  describe('responsive behavior', () => {
    it('should handle responsive layout classes', () => {
      ...
      const responsiveGrid = result.container.querySelector('[class*="lg:grid-cols-2"]')
    ...
    it('should handle responsive header layout', () => {
      ...
      const responsiveHeader = result.container.querySelector('[class*="sm:flex-row"]')
  ...
  describe('edge cases', () => {
    it('should handle empty section titles array', () => {
      const result = render(<SkeletonDetail sectionTitles={[]} contentSections={2} />)
