  ...
  describe("loader (GET requests)", () => {
    it("should return users for authenticated admin", async () => {
      ...
      vi.mocked(createClient).mockReturnValue({
        supabase: adminSupabaseClient as any,
        headers: new Headers(),
      });
    ...
    it("should return 401 for unauthenticated user", async () => {
      ...
      vi.mocked(createClient).mockReturnValue({
        supabase: noUserSupabaseClient as any,
        headers: new Headers(),
      });
    ...
    it("should return 403 for non-admin user", async () => {
      ...
      vi.mocked(createClient).mockReturnValue({
        supabase: regularUserSupabaseClient as any,
        headers: new Headers(),
      });
    ...
    it("should handle database errors gracefully", async () => {
      ...
      // Mock database error
      mockAdminUserOperations.getAllUsers.mockRejectedValueOnce(
  ...
  describe("action (POST requests)", () => {
    ...
    describe("updateRoles action", () => {
      it("should update user roles successfully", async () => {
        ...
        expect(mockAdminUserOperations.updateUserRoles).toHaveBeenCalledWith(
          "user-1",
          ["admin"]
        );
      });
    ...
    describe("deleteUser action", () => {
      it("should delete user successfully", async () => {
        ...
        expect(mockAdminUserOperations.deleteUser).toHaveBeenCalledWith(
          "disabled-user"
        );
      });
    ...
    describe("disableUser action", () => {
      it("should disable user successfully", async () => {
        ...
        expect(mockAdminUserOperations.disableUser).toHaveBeenCalledWith(
          "user-1"
        );
      });
    ...
    describe("enableUser action", () => {
      it("should enable user successfully", async () => {
        ...
        expect(mockAdminUserOperations.enableUser).toHaveBeenCalledWith(
          "disabled-user"
        );
      });
    });
