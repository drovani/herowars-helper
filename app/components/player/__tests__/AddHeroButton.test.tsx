...
describe('AddHeroButton', () => {
  ...
  describe('button states', () => {
    it('should render add button when hero is not in collection', () => {
      const result = render(<AddHeroButton {...defaultProps} isInCollection={false} />)

      expect(result.getByRole('button', { name: /add to collection/i })).toBeInTheDocument()
    ...
    it('should render collection status when hero is in collection', () => {
      const result = render(<AddHeroButton {...defaultProps} isInCollection={true} />)

      expect(result.getByRole('button', { name: /in collection/i })).toBeInTheDocument()
      expect(result.getByTitle('In Collection')).toBeInTheDocument()
    })

    it('should render loading state when isLoading is true', () => {
      const result = render(<AddHeroButton {...defaultProps} isLoading={true} />)
  ...
  describe('button interactions', () => {
    it('should call onAddHero when clicked', () => {
      ...
      const result = render(<AddHeroButton {...defaultProps} onAddHero={onAddHero} />)
    ...
    it('should not call onAddHero when hero is in collection', () => {
      const onAddHero = vi.fn()
      const result = render(<AddHeroButton {...defaultProps} isInCollection={true} onAddHero={onAddHero} />)
    ...
    it('should not call onAddHero when loading', () => {
      const onAddHero = vi.fn()
      const result = render(<AddHeroButton {...defaultProps} isLoading={true} onAddHero={onAddHero} />)
  ...
  describe('button variants and sizes', () => {
    ...
    it('should apply custom variant', () => {
      const result = render(<AddHeroButton {...defaultProps} variant="ghost" />)
  ...
  describe('custom styling', () => {
    it('should apply custom className', () => {
      const result = render(<AddHeroButton {...defaultProps} className="custom-class" />)
  ...
  describe('text content', () => {
    it('should have correct title text for different states', () => {
      ...
      result.rerender(<AddHeroButton {...defaultProps} isInCollection={true} />)
      expect(result.getByTitle('In Collection')).toBeInTheDocument()
