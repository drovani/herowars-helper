...
describe("UserRepository", () => {
  ...
  describe("getUser", () => {
    ...
    it("should throw error when user not found", async () => {
      ...
      await expect(repository.getUser("nonexistent")).rejects.toEqual({
  ...
  describe("updateUserRole", () => {
    it("should update user roles successfully", async () => {
      ...
      const result = await repository.updateUserRole("user-123", [
        "admin",
        "editor",
      ]);
    ...
    it("should handle update errors", async () => {
      ...
      await expect(
        repository.updateUserRole("user-123", ["admin"])
