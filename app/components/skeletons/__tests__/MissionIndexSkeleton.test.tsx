...
describe("MissionIndexSkeleton", () => {
  describe("basic rendering", () => {
    ...
    it("should render with custom className", () => {
      const result = render(
        <MissionIndexSkeleton className="custom-missions" />
      );
  ...
  describe("mission tiles", () => {
    it("should render mission tiles within chapters", () => {
      const result = render(
        <MissionIndexSkeleton chapterCount={1} missionsPerChapter={6} />
      );
  ...
  describe("boss hero placeholders", () => {
    it("should show boss styling on first and last mission tiles", () => {
      const result = render(
        <MissionIndexSkeleton chapterCount={1} missionsPerChapter={5} />
      );

      const bossBackgrounds = result.container.querySelectorAll(
        ".bg-orange-300\\/80"
      );
  ...
  describe("structure", () => {
    it("should have skeleton placeholders", () => {
      ...
      const skeletonElements =
        result.container.querySelectorAll(".animate-pulse");
  ...
  describe("edge cases", () => {
    ...
    it("should handle zero missions per chapter", () => {
      const result = render(
        <MissionIndexSkeleton chapterCount={1} missionsPerChapter={0} />
      );
