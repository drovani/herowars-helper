...
describe("SkeletonCard", () => {
  ...
  describe("combined configurations", () => {
    it("should handle header only configuration", () => {
      const result = render(
        <SkeletonCard showHeader={true} showContent={false} />
      );
    ...
    it("should handle content only configuration", () => {
      const result = render(
        <SkeletonCard showHeader={false} showContent={true} />
      );
    ...
    it("should handle minimal configuration", () => {
      const result = render(
        <SkeletonCard showHeader={false} showContent={false} />
      );
  ...
  describe("skeleton elements", () => {
    it("should render skeleton elements with proper classes", () => {
      ...
      const skeletonElements =
        result.container.querySelectorAll('[class*="rounded"]');
      expect(skeletonElements.length).toBeGreaterThan(0);
    });
