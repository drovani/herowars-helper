  ...
  describe('sortHeroRecords', () => {
    it('should sort heroes by name', () => {
      const heroes: HeroRecord[] = [
        { slug: 'z', name: 'Zeta', class: 'tank', faction: 'honor', main_stat: 'strength', attack_type: ['physical'], stone_source: [], order_rank: 1, updated_on: '2023-01-01T00:00:00.000Z' },
        { slug: 'a', name: 'Alpha', class: 'mage', faction: 'nature', main_stat: 'intelligence', attack_type: ['magic'], stone_source: [], order_rank: 2, updated_on: '2023-01-01T00:00:00.000Z' },
        { slug: 'b', name: 'Beta', class: 'warrior', faction: 'chaos', main_stat: 'agility', attack_type: ['physical'], stone_source: [], order_rank: 3, updated_on: '2023-01-01T00:00:00.000Z' },
      ];
  ...
  describe('Validation functions', () => {
    ...
    describe('validateAttackTypes', () => {
      it('should validate attack types correctly', () => {
        ...
        expect(validateAttackTypes(['magic', 'pure'])).toEqual(['magic', 'pure']);
    ...
    describe('validateBookName', () => {
      it('should validate book name correctly', () => {
        expect(validateBookName('Tome of Arcane Knowledge')).toBe('Tome of Arcane Knowledge');
        expect(validateBookName('Defender\'s Covenant')).toBe('Defender\'s Covenant');
