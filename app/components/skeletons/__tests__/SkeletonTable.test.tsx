...
describe("SkeletonTable", () => {
  ...
  describe("header configuration", () => {
    ...
    it("should mix custom titles with skeleton placeholders", () => {
      ...
      const result = render(
        <SkeletonTable headerTitles={headerTitles} columns={4} />
      );
      ...
      const skeletonHeaders = result.container.querySelectorAll(
        'thead th [class*="animate-pulse"]'
      );
  ...
  describe("skeleton elements", () => {
    ...
    it("should vary skeleton widths by column", () => {
      ...
      const firstColSkeletons =
        result.container.querySelectorAll('[class*="w-24"]');
